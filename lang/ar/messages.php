...
\n\n",
    ...
    'whatsapp_pairing_code_already_used' => 'تم استخدام هذا الرمز بالفعل. لا تُدخله مرة أخرى في واتساب — افتح واتساب واضغط ربط الجهاز في شاشة التحذير، أو اقطع الاتصال واطلب رمزاً جديداً.',
    ...
    'otp_sms_not_configured' => 'خدمة الرسائل النصية غير مهيأة على السيرفر. تواصل مع الدعم.',
    'otp_sms_send_failed' => 'تعذر إرسال رمز التحقق عبر SMS. حاول لاحقاً.',
    'otp_sms_message' => "قِران للدعوات الذكية\nلقد تم تسجيل حسابك بنجاح كود التفعيل :code",
    ...
    'otp_reset_code_sent_sms' => 'تم إرسال رمز إعادة تعيين كلمة المرور عبر SMS.',
    'otp_reset_code_sent_sms' => 'تم إرسال رمز إعادة تعيين كلمة المرور عبر SMS.',
