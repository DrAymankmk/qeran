...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Create Link - {{ ucfirst($type) }}</h4>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="icon" class="form-control" value="{{old('icon')}}" placeholder="e.g., fab fa-facebook, fas fa-envelope">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="type" class="form-control" value="{{old('type')}}" placeholder="e.g., social, contact, quick">
                                <small class="form-text text-muted">Optional: social, contact, quick, custom</small>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
