...
<div class="row">
	<div class="col-12">
		<div class="page-title-box d-sm-flex align-items-center justify-content-between">
			<h4 class="mb-sm-0 font-size-18">{{__('cms.create-cms-page')}}</h4>
			<div class="page-title-right">
				<ol class="breadcrumb m-0">
					...
					<li class="breadcrumb-item active">{{__('cms.create-cms-page')}}</li>
				</ol>
			</div>
		</div>
	</div>
		...
		<div class="card">
			<div class="card-body">
				<form action="{{route('cms.pages.store')}}" method="POST">
						...
						<div class="tab-pane fade" id="ar-content" role="tabpanel"
							...
							<div class="mb-3">
								...
								<textarea name="ar[meta_description]"
									class="form-control"
									rows="2">{{old('ar.meta_description')}}</textarea>
							</div>
						</div>
						<!-- English Tab -->
						<div class="tab-pane fade show active" id="en-content"
							...
							<div class="mb-3">
								...
								<textarea name="en[meta_description]"
									class="form-control"
									rows="2">{{old('en.meta_description')}}</textarea>
							</div>
						</div>
					...
					<div class="mb-3">
						<button type="submit"
							class="btn btn-primary">{{__('admin.create')}}
							{{__('cms.page')}}</button>
