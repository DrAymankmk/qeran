...
<head>
	...
	<link href="https://fonts.bunny.net/css?family=cairo:400,600,700|playfair-display:400,700|cormorant-garamond:400,600|great-vibes:400"
		rel="stylesheet">
	<style>
	* {
		margin: 0;
...
<body>
	...
	<div class="ib-preview-shell" @if(empty($useBuilderWedding)) style="flex-direction: column;" @endif>
		@include($view, array_merge(
			[
			...
			isset($template) ? ['template' => $template] : []
		))
		@if(empty($useBuilderWedding))
