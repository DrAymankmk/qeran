...
<head>
	...
	<title>{{ $title ?? __('New Invitation Created') }}</title>
	@php
...
<body>
	<div class="container">
		<div class="header">
			<h1 style="margin: 0;">🎉 {{ __('admin.new-invitation-created') }}
			</h1>
			<p style="margin: 10px 0 0 0; font-size: 16px;">
				{{ __('admin.new-invitation-created') }}</p>
		</div>
		<div class="content">
			<div class="title">{{ $title ?? __('admin.new-invitation-created') }}</div>
			<div class="body">
				{!! nl2br(e($body ?? '')) !!}
			</div>
			@if(isset($invitation))
