...
<head>
	...
	<title>{{ $title ?? __('admin.new-user-registered') }}</title>
	@php
...
<body>
	<div class="container">
		<div class="header">
			<h1 style="margin: 0;">{{ __('admin.new-user-registered') }}</h1>
			<p style="margin: 10px 0 0 0; font-size: 16px;">
				{{ __('admin.new-user-registration-description') }}</p>
		</div>
		<div class="content">
			<div class="title">{{ $title ?? __('admin.new-user-registered') }}</div>
			<div class="body">
				{!! nl2br(e($body ?? '')) !!}
			</div>
			...
			<div class="user-info">
				...
				@if(isset($targetId))
				<div class="info-row">
					<span class="info-label">{{ __('admin.registration-date') }}:</span>
