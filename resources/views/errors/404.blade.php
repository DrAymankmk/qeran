...
<html lang="ar" dir="rtl">
  <head>
    <meta charset="utf-8" />
    <title>{{__('admin.project-name')}} - الصفحة غير موجودة</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />
    <meta name="format-detection" content="telephone=no" />
    <meta name="apple-mobile-web-app-capable" content="yes" />
    <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" />
    <meta
      content="{{__('admin.project-name')}} - الصفحة غير موجودة"
      name="{{__('admin.project-name')}} - الصفحة غير موجودة"
    />
    <link
      rel="shortcut icon"
    ...
    <div class="container">
      ...
      <div class="error-content glass">
        ...
        <p class="error-description">
          الصفحة التي تبحث عنها غير موجودة أو قد تم نقلها إلى مكان آخر.
