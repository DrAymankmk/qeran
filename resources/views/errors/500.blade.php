...
<html lang="ar" dir="rtl">
  <head>
    <meta charset="utf-8" />
    <title>{{__('admin.project-name')}} - خطأ في الخادم</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />
    <meta name="format-detection" content="telephone=no" />
    <meta name="apple-mobile-web-app-capable" content="yes" />
    <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" />
    <meta
      content="{{__('admin.project-name')}} - خطأ في الخادم"
      name="{{__('admin.project-name')}} - خطأ في الخادم"
    />
    <link
      rel="shortcut icon"
  ...
  <body>
    <div class="container">
      ...
      <div class="error-content glass">
        ...
        <h2 class="error-subtitle">حدث خطأ غير متوقع</h2>
        <p class="error-description">
          نعتذر، حدث خطأ في الخادم أثناء معالجة طلبك. 
          يرجى المحاولة مرة أخرى لاحقاً أو التواصل مع فريق الدعم إذا استمرت المشكلة.
        </p>
