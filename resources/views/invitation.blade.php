...
<head>
	...
	<meta property="og:image" itemprop="image" content="{{asset('admin_assets/images/logo.png')}}" />
	<meta property="og:image:secure_url" itemprop="image" content="{{asset('admin_assets/images/logo.png')}}" />
	...
	* {
	...
	/* Base Envelope Styles (Default - Template 1) */
	.envelope {
	...
	/* Template-specific envelope styles are defined in each template file */
			...
			<div id="successView" class="status-view glass">
				...
				<div class="success-image-container">
					...
					<a href="{{$mediaUrl}}" target="_blank" rel="noopener noreferrer">
						<video class="success-event-image success-event-video"
					...
					<a href="{{$mediaUrl}}" target="_blank" rel="noopener noreferrer">
						<img src="{{$mediaUrl}}" alt="{{$invitation->event_name}}"
							class="success-event-image" loading="lazy" />
					</a>
					@endif
				</div>
				@endif
						...
						<div class="detail-content">
							...
							<div class="detail-value">
								...
								<svg width="16" height="16"
									...
									fill="none"
									xmlns="http://www.w3.org/2000/svg"
									style="margin-right: 8px; opacity: 0.7; vertical-align: middle;">
				...
				<div class="user-info-section">
					...
					<div class="user-info-content">
						...
						<div class="user-info-item">
							...
							<div class="user-info-content-text">
								<div class="user-info-label">رقم الهاتف
								</div>
								<div class="user-info-value">
						...
						<div class="user-info-item">
							<div class="user-info-icon count-icon">
								<svg width="24" height="24"
									...
									fill="none"
									xmlns="http://www.w3.org/2000/svg">
									<path d="M16 4C18.2091 4 20 5.79086 20 8V16C20 18.2091 18.2091 20 16 20H8C5.79086 20 4 18.2091 4 16V8C4 5.79086 5.79086 4 8 4H16ZM16 2H8C4.68629 2 2 4.68629 2 8V16C2 19.3137 4.68629 22 8 22H16C19.3137 22 22 19.3137 22 16V8C22 4.68629 19.3137 2 16 2Z"
										fill="currentColor" />
									<path d="M7 12H17V10H7V12ZM10 16H17V14H10V16ZM7 8H17V6H7V8Z"
										fill="currentColor" />
								</svg>
							</div>
							<div class="user-info-content-text">
								<div class="user-info-label">عدد الدعوات
								</div>
								<div class="user-info-value">
									{{$user->pivot->invitation_count ?? 1}}
									دعوة
								</div>
							</div>
						</div>
