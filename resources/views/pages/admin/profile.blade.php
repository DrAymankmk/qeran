						...
						<div class="col-md-8">
							...
							<div class="mb-3">
								<label for="password_confirmation"
									class="form-label">{{__('admin.confirm-password')}}</label>
								<input type="password"
									class="form-control"
							...
							<div class="mb-3">
								<label for="image"
									class="form-label">{{__('admin.profile-image')}}</label>
								<input type="file"
						...
						<div class="col-md-4">
							<div class="text-center mb-3">
								...
								<p class="text-muted mt-2 mb-0">
									{{__('admin.current-profile-image')}}
								</p>
							</div>
						</div>
					</div>
...
document.getElementById('image').addEventListener('change', function(e) {
	...
	if (file) {
		...
		reader.onload = function(e) {
			document.getElementById('imagePreview').src = e.target
				.result;
		}
