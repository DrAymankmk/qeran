...
<div class="row">
	<div class="col-12">
		<div class="page-title-box d-sm-flex align-items-center justify-content-between">
			<h4 class="mb-sm-0 font-size-18">{{__('admin.add-admin')}}</h4>

			<div class="page-title-right">
				<ol class="breadcrumb m-0">
					<li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{__('admin.Dashboard')}}</a></li>
					<li class="breadcrumb-item"><a href="{{route('admins.index')}}">{{__('admin.admins')}}</a></li>
					<li class="breadcrumb-item active">{{__('admin.add-admin')}}</li>
				</ol>
			</div>
		</div>
	</div>
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="mb-3">
								...
								<input type="email" required name="email" value="{{old('email')}}" class="form-control" id="email" placeholder="{{__('admin.email')}}">
							</div>

							<div class="mb-3">
								<label for="password" class="form-label">{{__('admin.password')}} <span class="text-danger">*</span></label>
								<input type="password" required name="password" class="form-control" id="password" placeholder="{{__('admin.password')}}" minlength="6">
								<small class="form-text text-muted">{{__('admin.password-min-6')}}</small>
							</div>
						</div>
					</div>
