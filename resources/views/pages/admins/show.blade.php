		...
		<div class="page-title-box d-sm-flex align-items-center justify-content-between">
			...
			<div class="page-title-right">
				<ol class="breadcrumb m-0">
					...
					<li class="breadcrumb-item"><a
							href="{{route('admins.index')}}">{{__('admin.admins')}}</a>
					</li>
			...
			<div class="card-body">
				<div class="row">
					...
					<div class="col-md-8">
						...
						<div class="mb-3">
							<label
								class="form-label fw-bold">{{__('admin.id')}}:</label>
							<p class="mb-0">{{$admin->id}}</p>
						</div>

						<div class="mb-3">
							<label
								class="form-label fw-bold">{{__('admin.name')}}:</label>
							<p class="mb-0">{{$admin->name}}</p>
						</div>

						<div class="mb-3">
							<label
								class="form-label fw-bold">{{__('admin.email')}}:</label>
							<p class="mb-0">{{$admin->email}}</p>
						</div>

						<div class="mb-3">
							<label
								class="form-label fw-bold">{{__('admin.created_at')}}:</label>
							<p class="mb-0">
						...
						<div class="mb-3">
							<label
								class="form-label fw-bold">{{__('admin.updated_at')}}:</label>
							<p class="mb-0">
						...
						<div class="mb-3">
							<label
								class="form-label fw-bold">{{__('admin.roles')}}:</label>
							<div>
								@if($admin->roles &&
								$admin->roles->count() > 0)
								...
								@else
								<span
									class="badge bg-danger">{{__('admin.no-roles')}}</span>
								@endif
							</div>
						</div>
						...
						<div class="d-flex gap-2 mt-4">
							<a href="{{route('admins.edit', $admin->id)}}"
								...
								<i
									class="mdi mdi-file-edit-outline"></i>
								{{__('admin.edit')}}
							</a>
