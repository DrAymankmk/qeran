                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="ar[name]" value="{{old('ar[name]')}}" required
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="ar[description]" class="form-control" id="formrow-description-input" rows="4"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="en[name]" value="{{old('en[name]')}}" required
                                                       class="form-control" id="formrow-firstname-input"
                                                       placeholder="{{__('admin.name')}}">
                                            </div>
