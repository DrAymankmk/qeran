                        ...
                        <table class="table table-hover datatable dt-responsive nowrap"
                            ...
                            @foreach($categories as $category)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a target="_blank" href="{{$category->img}}">

                                        <img class=" header-profile-user" src="{{$category->image()}}" alt="Header Avatar">
                                        </a>
                                    </td>
                                    <td> {{$category->name}}</td>
...
{{--                                            @can('edit_categories')--}}
                                                ...
                                                <a href="{{route('category.edit',$category->id)}}" title="{{__('admin.edit')}}" class="text-success"><i
                                                        class="mdi mdi-pencil font-size-18"></i></a>
{{--                                            @endcan--}}
{{--                                            @can('delete_categories')--}}

                                                <a onclick="openModalDelete({{$category->id}})" title="{{__('admin.delete')}}" class="text-danger"><i
...
@section('extra-js')
    ...
    <script>
        function openModalDelete(category_id) {
            $('.action_form').attr('action', '{{route('category.destroy', '')}}' + '/' + category_id);
