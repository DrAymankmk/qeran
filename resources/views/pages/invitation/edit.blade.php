					...
					<div class="tab-content crypto-buy-sell-nav-content p-4">
						...
						<div class="mb-3">
							<label for="formrow-firstname-input"
								class="form-label"> {{__('admin.desc')}}
							</label>
							<textarea class="form-control" id="productdesc"
								disabled rows="10"
								placeholder=" {{__('admin.desc')}}">{{$invitation->description}}</textarea>
						</div>

						<div class="mb-3">
							<label for="formrow-firstname-input"
								class="form-label">
								{{__('admin.upload-invitation-file')}}
							</label>
						...
						<div class="mb-3">
							...
							<input name="date" style="text-align: right;"
								class="form-control " type="date"
								value="{{\Carbon\Carbon::parse($invitation->date)->format('Y-m-d')}}"
								id="start_at-input">
						</div>
							...
							<div class="col-lg-12">
								<div class="form-group">
									...
									<input type="hidden"
										name="latitude"
										id="latitude"
										value="{{$invitation->latitude}}">
									<input type="hidden"
										name="longitude"
										id="longitude"
										value="{{$invitation->longitude}}">
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDhnmMC23noePz6DA8iEvO9_yNDGGlEaeM&callback=initAutocomplete&v=weekly&libraries=places"
	async></script>
<script>
function initAutocomplete() {
	...
	searchBox.addListener("places_changed", () => {
		...
		places.forEach((place) => {
			...
			$('#longitude').val(place.geometry.location
				.lng());
