								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="mb-3">
											...
											<input type="text"
												name="bucket_name"
												value="{{old('bucket_name', $medium->bucket_name)}}"
												class="form-control"
												id="bucket_name"
									...
									<div class="col-sm-12">
										<div class="mb-3">
											...
											<div
												...
												{{$medium->extension ?? 'N/A'}}
												<br>
												<strong>Size:</strong>
												{{$medium->size ? number_format($medium->size / 1024, 2) . ' KB' : 'N/A'}}
												<br>
												<strong>MIME
													Type:</strong>
												{{$medium->getMimeType ?? 'N/A'}}
												<br>
												<strong>Path:</strong>
	...
	if (file) {
		if (file.type.startsWith('image/')) {
			...
			reader.onload = function(e) {
				preview.innerHTML =
					'<div class="alert alert-info"><strong>New Image Preview:</strong><br><img src="' +
					e.target.result +
					'" class="img-thumbnail mt-2" style="max-width: 300px; max-height: 300px;"></div>';
			};
			reader.readAsDataURL(file);
		} else if (file.type.startsWith('video/')) {
			preview.innerHTML =
				'<div class="alert alert-info"><i class="mdi mdi-video"></i> <strong>New Video File Selected:</strong> ' +
				file.name +
				'<br><small>Video preview will be available after upload.</small></div>';
		} else if (file.type.startsWith('audio/')) {
			preview.innerHTML =
				'<div class="alert alert-info"><i class="mdi mdi-music"></i> <strong>New Audio File Selected:</strong> ' +
				file.name + '</div>';
		} else {
			preview.innerHTML =
