							...
							<div class="row">
								<div class="mb-3">
									<label for="formrow-inputState"
										class="form-label">
										{{__('admin.package-invitation-type')}}
									</label>
									<select id="formrow-inputState"
										class="form-select"
										name="package_invitation_type">
										<option selected=""
											disabled>
											{{__('admin.choose-package-invitation-type')}}
										</option>
										@foreach(\App\Helpers\Constant::INVITATION_TYPE as $key=>$type)
										<option value="{{$type}}"
											@if($package->
											package_invitation_type==$type)
											selected
											@endif>{{__('admin.invitation-type-'.$type)}}
										</option>
										@endforeach
									</select>
								</div>
								...
								<div class="mb-3">
									...
									<select id="formrow-inputState"
										...
										<option value="{{$type}}"
											...
											package_type==$type)
											selected
											@endif>{{__('admin.package-type-'.$type)}}
										</option>
										@endforeach
									</select>
								</div>
							...
							<div class="row">
								...
								<div class="col-sm-12">
									<div class="mb-3">
										<label for="formrow-firstname-input"
											class="form-label">
											{{__('admin.free_invitations_count')}}
										</label>
										<input type="number"
											name="free_invitations_count"
											value="{{$package->free_invitations_count}}"
											required
											class="form-control"
											id="formrow-firstname-input"
									...
									<div class="row">
										<div
											...
											<div
												...
												<input type="text"
													name="en[title]"
													value="{{old('en.title', $package->translate('en')->title ?? '')}}"
													class="form-control"
													id="en-title"
										...
										<div
											...
											<div
												class="mb-3">
												<label for="en-subtitle"
													class="form-label">Subtitle
													(EN)</label>
												<input type="text"
													name="en[subtitle]"
													value="{{old('en.subtitle', $package->translate('en')->subtitle ?? '')}}"
													class="form-control"
													id="en-subtitle"
										...
										<div
											...
											<div
												...
												<textarea name="en[content]"
													...
													id="en-content"
													rows="5"
													placeholder="Package Content">{{old('en.content', $package->translate('en')->content ?? '')}}</textarea>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="row">
										<div
											...
											<div
												...
												<input type="text"
													name="ar[title]"
													value="{{old('ar.title', $package->translate('ar')->title ?? '')}}"
													class="form-control"
													id="ar-title"
										...
										<div
											...
											<div
												class="mb-3">
												<label for="ar-subtitle"
													class="form-label">العنوان
													الفرعي
													(AR)</label>
												<input type="text"
													name="ar[subtitle]"
													value="{{old('ar.subtitle', $package->translate('ar')->subtitle ?? '')}}"
													class="form-control"
													id="ar-subtitle"
										...
										<div
											...
											<div
												class="mb-3">
												<label for="ar-content"
													class="form-label">المحتوى
													(AR)</label>
												<textarea name="ar[content]"
													class="form-control summernote"
													id="ar-content"
													rows="5"
													placeholder="محتوى الباقة">{{old('ar.content', $package->translate('ar')->content ?? '')}}</textarea>
											</div>
										</div>
									</div>
								</div>
