...
<div class="row">
	<div class="col-12">
		<div class="page-title-box d-sm-flex align-items-center justify-content-between">
			<h4 class="mb-sm-0 font-size-18">{{__('admin.edit-permission')}}</h4>

			<div class="page-title-right">
				<ol class="breadcrumb m-0">
					<li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{__('admin.Dashboard')}}</a></li>
					<li class="breadcrumb-item"><a href="{{route('permissions.index')}}">{{__('admin.permissions')}}</a></li>
					<li class="breadcrumb-item active">{{__('admin.edit-permission')}}</li>
				</ol>
			</div>
		</div>
	</div>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="mb-3">
								...
								<input type="text" required name="name" value="{{old('name', $permission->name)}}" class="form-control" id="name" placeholder="{{__('admin.name')}}">
