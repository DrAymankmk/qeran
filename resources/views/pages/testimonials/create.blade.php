...
<div class="row">
	<div class="col-12">
		<div class="page-title-box d-sm-flex align-items-center justify-content-between">
			<h4 class="mb-sm-0 font-size-18">{{__('admin.create-testimonial')}}</h4>
							...
							<div class="tab-pane active" id="buy"
								...
								<div class="row">
									<div class="col-sm-6">
										<div class="mb-3">
											<label for="rating"
												class="form-label">{{__('admin.rating')}}</label>
											<select id="rating"
												class="form-select"
												name="rating">
												<option
											...
											<div
												...
												<div
													...
													<label for="en-message"
														class="form-label">{{__('admin.testimonial-message-en')}}
														<span
															class="text-danger">*</span></label>
													<textarea name="en[message]"
														...
														rows="5"
														required
														placeholder="{{__('admin.testimonial-message-en')}}">{{old('en.message')}}</textarea>
												</div>
											</div>
										</div>
									</div>
											...
											<div
												...
												<div
													...
													<label for="ar-message"
														class="form-label">{{__('admin.testimonial-message-ar')}}
														<span
															class="text-danger">*</span></label>
													<textarea name="ar[message]"
														...
														rows="5"
														required
														placeholder="{{__('admin.testimonial-message-ar')}}">{{old('ar.message')}}</textarea>
												</div>
											</div>
										</div>
									</div>
