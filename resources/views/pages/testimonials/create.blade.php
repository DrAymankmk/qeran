                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="en[job]" value="{{old('en.job')}}"
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="en[message]" class="form-control" id="en-message" rows="5" required
                                                                  placeholder="Testimonial message">{{old('en.message')}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="ar[job]" value="{{old('ar.job')}}"
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="ar[message]" class="form-control" id="ar-message" rows="5" required
                                                                  placeholder="رسالة الشهادة">{{old('ar.message')}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
