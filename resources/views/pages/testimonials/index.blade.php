...
<div class="row">
	<div class="col-12">
		<div class="page-title-box d-sm-flex align-items-center justify-content-between">
			<h4 class="mb-sm-0 font-size-18">{{__('admin.testimonials')}}</h4>
					...
					<div class="col-sm-12">
						<div class="text-sm-start">
							<a href="{{route('testimonials.create')}}"
								...
								{{__('admin.add-new-testimonial')}} </a>
						</div>
					</div>
				</div>
					...
					<table id="testimonialsTable"
						...
						<thead>
							<tr class="tr-colored">
								...
								<th scope="col">{{__('admin.rating')}}
								</th>
								<th scope="col">{{__('admin.status')}}
								</th>
								<th scope="col">{{__('admin.order')}}
								</th>
								<th scope="col">
									{{__('admin.created_at')}}
								</th>
						...
						<tbody>
							...
							<tr>
								<td><a href="javascript: void(0);"
										class="text-body fw-bold">{{$testimonial->id}}</a>
								</td>
								<td>
								...
								<td>
									<div class="d-flex gap-3">
										...
										<a onclick="openModalDelete({{$testimonial->id}})"
