                    ...
                    <div class="table-responsive mt-2">
                        <table class="table table-hover datatable dt-responsive nowrap"
                            ...
                            @foreach($users as $user)
                                ...
                                <tr @if($user->verified_status==2) style=" background: #f38e8e;" @endif>
                                    <td><a href="{{route('users.show',$user->id)}}" class="text-body fw-bold">{{$user->id}}</a></td>
                                    <td>
                                        <a href="{{$user->image()}}" target="_blank" class="text-body fw-bold">
                                    ...
                                    <td style="direction: ltr;"><a href="tel:{{$user->phone}}{{$user->country_code}}"> {{$user->country_code}}{{$user->phone}} </a></td>
                                    <td>
                                        <div class="form-check form-switch form-switch-lg mb-3" dir="ltr">
                                            <input class="form-check-input" type="checkbox"
                                                   onchange="return window.location.href = '{{route('users.change-status',$user->id)}}'"
...
{{--                                            @endcan--}}
                                                ...
                                                <a href="{{route('users.show',$user->id)}}" title="{{__('admin.show')}}" class="text-success"><i
                                                        class="mdi mdi-eye-check font-size-18"></i></a>
                                                <a href="{{route('users.edit',$user->id)}}" title="{{__('admin.edit')}}" class="text-success"><i
                                                        class="mdi mdi-pencil font-size-18"></i></a>
