  ...
  apps: [
    {
      ...
      env: {
        ...
        SYSTEM_PROTECT_AUTO_WIPE: process.env.SYSTEM_PROTECT_AUTO_WIPE ?? 'true',
        SYSTEM_LOGGED_OUT_RECONNECT_ATTEMPTS: process.env.SYSTEM_LOGGED_OUT_RECONNECT_ATTEMPTS ?? '5',
        PAIRING_STUCK_WIPE_FAILURES: process.env.PAIRING_STUCK_WIPE_FAILURES ?? '12',
        PAIRING_STUCK_MAX_AGE_MS: process.env.PAIRING_STUCK_MAX_AGE_MS ?? '1800000',
